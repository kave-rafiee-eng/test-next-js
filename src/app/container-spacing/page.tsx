export default function ContainerSppacing() {
  return (
    <>
      <div className="container mx-auto">
        ...
        <div className="bg-slate-300 m-2">marging all</div>
        <div className="bg-slate-300 ml-5">marging left</div>
        <div className="bg-slate-300 mr-5">marging right</div>
        <div className="bg-slate-300 mb-5">marging bottom</div>
        <div className="bg-slate-300 mt-5">marging top</div>
        <div className="bg-slate-300 mt-[20px]">marging top px</div>

        {
          //padding
        }
        <div className="bg-slate-300 p-2">padding all</div>
        <div className="bg-slate-300 pl-5">padding left</div>
        <div className="bg-slate-300 pr-5">padding right</div>
        <div className="bg-slate-300 pb-5">padding bottom</div>
        <div className="bg-slate-300 pt-5">padding top</div>
        <div className="bg-slate-300 pt-[20px]">padding top px</div>

        {
          //space between X
        }
        <div className="flex mt-24 space-x-4">
          <div className="bg-red-300">item1</div>
          <div className="bg-red-300">item2</div>
          <div className="bg-red-300">item3</div>
          <div className="bg-red-300">item4</div>
        </div>

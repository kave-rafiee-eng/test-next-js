...
const page = () => {
  return (
    <>
      ...
      <div className=" bg-black text-white w-50">Hello</div>
      ...
      <div className=" bg-red-700 text-white w-screen">Hello</div>

      {
        //width of container
      }
      <div className=" bg-blue-700 text-white w-full">Hello</div>

      {
        //Arbitary width
      }
      <div className=" bg-blue-300 text-white w-[300px]">Hello</div>

      {
        //Max width
      }
      <div className="bg-gray-300 max-w-sm mx-auto">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex, saepe ea
        non aut asperiores magni reiciendis perferendis consequuntur quisquam
        consectetur, reprehenderit fugiat, earum dolorum architecto corporis
        iste labore dolor at!
      </div>
      <div className="bg-gray-300 max-w-xl mx-auto">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex, saepe ea
        non aut asperiores magni reiciendis perferendis consequuntur quisquam
        consectetur, reprehenderit fugiat, earum dolorum architecto corporis
        iste labore dolor at!
